...
import utilisateur.service.jeuEssai.ServiceJeuEssai;
...
public class ServiceUtilisateur implements IServiceUtilisateur{
	...
	@EJB
	private ServiceJeuEssai serviceJeuEssai;
	...
	public String[] listeToTab(Collection<DroitUtilisateur> liste){
		return serviceLister.listeToTab(liste);
	}
